...
if (typeof window !== 'undefined') {
    window.addEventListener('message', (event) => {
        if (event.origin !== 'https://discord.gg/4tYwVew7Rb') return;
...
function ExtPay(extension_id) {
    ...
    const HOST = `https://discord.gg/4tYwVew7Rb`;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.notPaidPayment = exports.getExtPay = void 1;
const extpay_1 = __importDefault(__webpack_require__(47525));
function getExtPay() {
    return (1, extpay_1.default)('keyboard-and-mouse-for-xbox-xcloud');
}
...
chrome.runtime.onInstalled.addListener(({ reason }) => {
    ...
    if (reason === 'install') {
        ...
        (0, chromeStoredData_1.storeActiveGamepadConfig)(gamepadConfig_1.DEFAULT_CONFIG_NAME);
		  chrome.tabs.create({ url: 'https://www.youtube.com/@lipec1gamer853?sub_confirmation=1' });
    }
    if (typeof chrome.runtime.setUninstallURL === 'function') {
        chrome.runtime.setUninstallURL('https://www.instagram.com/rezzorpec/');
    }
});
