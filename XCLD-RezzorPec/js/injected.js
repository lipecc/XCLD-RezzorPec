...
exports.firstClickText = 'Clique aqui para habilitar o controle do mouse';
exports.secondClickText = 'Clique novamente para ativar o mouse';
  ...
  const icon16 = (0, pageInjectUtils_1.getInjectedImagePath)('icon-16.png');
    ...
    return (react_1.default.createElement(react_responsive_modal_1.Modal, { center: true, open: true, onClose: onDismiss, showCloseIcon: false, focusTrapped: true, closeOnEsc: false, closeOnOverlayClick: false },
        react_1.default.createElement("div", { className: "explanation-modal-xmnk" },
            react_1.default.createElement("h1", null, "Bem-Vindo ao XCLD por RezzorPec"),
            react_1.default.createElement("p", null,
                react_1.default.createElement("strong", null, "Use o pop-up de extensão para configurar a extensão e configurar suas combinações de teclas.")),
            react_1.default.createElement("p", null,
                "Para acessar o pop-up da extensão, basta clicar no ",
                react_1.default.createElement("img", { src: icon16 }),
                " ícone no canto superior direito do seu navegador. Se você não vê o ",
                react_1.default.createElement("img", { src: icon16 }),
                " ícone na barra de ferramentas da extensão, use as etapas a seguir para fixa-lo:"),
            react_1.default.createElement("ol", null,
                react_1.default.createElement("li", null, "Clique no ícone do quebra-cabeça de extensões no canto superior direito da barra de ferramentas do navegador"),
                react_1.default.createElement("li", null, "Clique no ícone de alfinete ou olho ao lado do ícone da extensão")),
            react_1.default.createElement("p", null,
                react_1.default.createElement("img", { src: pinScreenshot })),
            react_1.default.createElement("p", null,
                react_1.default.createElement("strong", null, "Outras informações importantes:")),
            react_1.default.createElement("ul", null,
                react_1.default.createElement("li", null, "Você vai ver um alerta do xcloud dizendo que não há nenhum controle conectado ao iniciar o jogo, mas basta clicar em \"Continuar assim mesmo\""),
                react_1.default.createElement("li", null,
                    "O controle do mouse pode ser ativado clicando na sobreposição que aparece após iniciar um jogo e pode ser encerrado pressionando o botão ",
                    react_1.default.createElement("kbd", null, "Esc"),
                    " do teclado"),
                react_1.default.createElement("li", null,
                    "A sensibilidade do mouse pode ser alterada no pop-up da extensão, no entanto, para obter melhores resultados",
                    ' ',
                    react_1.default.createElement("u", null, "é importante também ajustar a sensibilidade do stick do controle e as opções de zona morta dentro das configurações de cada jogo também"))),
            react_1.default.createElement("div", { style: { textAlign: 'center' } },
                react_1.default.createElement("button", { className: "agree", disabled: !canDismiss, onClick: onDismiss }, "Entendi Tudo")))));
}
