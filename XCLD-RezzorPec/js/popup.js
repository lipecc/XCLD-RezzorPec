    ...
    return (react_2.default.createElement("form", { className: "vertical full-height", onSubmit: handleSubmit },
        ...
        react_2.default.createElement("section", { className: "horizontal space-between padding-top-s" },
            react_2.default.createElement("div", { className: "margin-right-s" },
                ...
                !isEditing ? (react_2.default.createElement(react_1.DefaultButton, { className: "margin-left-s", disabled: isDefaultConfig, onClick: handleDelete, title: isDefaultConfig ? 'Default preset cannot be deleted' : undefined }, "Deletar")) : null,
                !isEditing ? (react_2.default.createElement(react_1.DefaultButton, { className: "margin-left-s", onClick: handleExport }, "Exportar Config")) : null),
            isEditing ? (react_2.default.createElement(react_1.PrimaryButton, { type: "submit", disabled: state.errors.hasErrors || !hasChanges || isSubmitting, iconProps: saveIcon }, isNewDraft ? 'Criar' : 'Salvar')) : (react_2.default.createElement(react_1.PrimaryButton, { onClick: handleActivate, enabled: state.errors.hasErrors || isActive || isSubmitting, iconProps: useIcon }, "Usar")))));
}
    ...
    return (react_2.default.createElement("div", null,
        react_2.default.createElement("div", { className: "global-prefs-body" },
            react_2.default.createElement("section", null,
                ...
                react_2.default.createElement(react_1.Checkbox, { label: "Mostrar overlay de controles na tela.", checked: prefs.showControlsOverlay, onChange: handleChange, title: "Show an overlay with all button bindings visible during play" })),
            ...
            react_1.default.createElement("div", { className: "horizontal centered" },
                react_1.default.createElement("div", { className: "vertical centered-v left-aligned margin-right" },
                    react_1.default.createElement("div", { className: "overflow-ellipsis" },
                        react_1.default.createElement("small", null, "Jogando:"),
                        " ",
                        react_1.default.createElement("span", null, gameName || 'RezzorPec')),
                    react_1.default.createElement("div", { className: "overflow-ellipsis" },
                        react_1.default.createElement("small", null, "Predefinição:"),
                        " ",
                        react_1.default.createElement("span", null, activeConfig || 'RezzorPec'))),
...
const getMenuItems = (isPaid, onPay) => [
    {
        key: 'version',
        text: `Versão ${chrome.runtime.getManifest().version}`,
        disabled: true,
    },
    {
        key: 'about',
    ...
    {
        key: 'issues',
        text: 'RezzorPec insta',
        href: 'https://www.instagram.com/rezzorpec/',
        target: '_blank',
        iconProps: { className: 'discord-icon' },
    },
	{
         key: 'channel',
         text: 'canal do Jonymzs ',
         href: 'https://www.youtube.com/@JonyMzs',
         target: '_blank',
         iconProps: { className: 'youtube-icon' },
    },
{
  key: 'xcloud',
  text: 'Abrir XCloud',
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        isOpen ? (react_1.default.createElement(react_2.Callout, { setInitialFocus: true, gapSpace: 0, directionalHint: react_2.DirectionalHint.bottomRightEdge, target: `#${buttonId}`, onDismiss: handleClose, 
            ...
            react_1.default.createElement("div", { style: { width: 250 }, className: "padding-full" },
                react_1.default.createElement(react_2.TextField, { placeholder: "Nome do novo modelo", autoFocus: isOpen, value: name, maxLength: 18, onKeyPress: handleKeyPress, onChange: (e) => setName(e.currentTarget.value) }),
                ...
                react_1.default.createElement("div", { className: "horizontal space-between margin-top-s" },
                    react_1.default.createElement(react_2.DefaultButton, { disabled: !name || isTaken, onClick: handleImport }, "Importar Modelo"),
                    react_1.default.createElement(react_2.PrimaryButton, { disabled: !name || isTaken, onClick: handleSubmit }, "Criar Novo Modelo"))))) : null));
}
...
function UpsellModal() {
    ...
    return (react_2.default.createElement(react_responsive_modal_1.Modal, { center: true, open: show, onClose: handleClose, showCloseIcon: true, focusTrapped: true, closeOnEsc: true },
        react_2.default.createElement("div", { className: "explanation-modal-xmnk" },
            react_2.default.createElement("h2", null, "Essa área da extensão ainda não foi desbloqueada."),
            react_2.default.createElement("p", null,
                react_2.default.createElement("strong", null, "Entre no servidor do discord para ser um dos primeiros a receber quando lançar!")),
            react_2.default.createElement("ul", null,
                react_2.default.createElement("li", null, "Compra bloqueada."),
                react_2.default.createElement("li", null, "Compra bloqueada."),
                react_2.default.createElement("li", null, "Compra bloqueada.")),
            react_2.default.createElement("div", { style: { textAlign: 'center' } },
                react_2.default.createElement(react_1.CompoundButton, { primary: true, secondaryText: `Você não paga nada. R${price}`, onClick: openPaymentPage, styles: { root: { width: '100%' }, textContainer: { textAlign: 'center' } } }, "Compra bloqueada.")))));
}
...
exports.fluentXboxHeaderTheme = {
    palette: {
        themePrimary: '#741BA1',
        themeLighterAlt: '#741BA1',
        themeLighter: '#741BA1',
        themeLight: '#741BA1',
        themeTertiary: '#741BA1',
        themeSecondary: '#741BA1',
        themeDarkAlt: '#741BA1',
        themeDark: '#741BA1',
        themeDarker: '#741BA1',
        neutralLighterAlt: '#741BA1',
        neutralLighter: '#741BA1',
        neutralLight: '#741BA1',
        neutralQuaternaryAlt: '#741BA1',
        neutralQuaternary: '#741BA1',
        neutralTertiaryAlt: '#4F0973',
        neutralTertiary: '#B119FF',
        neutralSecondary: '#B119FF',
        neutralPrimaryAlt: '#B119FF',
        neutralPrimary: '#B119FF',
        neutralDark: '#B119FF',
        black: '#B119FF',
        white: '#B119FF',
    },
